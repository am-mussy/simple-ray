...
func (c *CLI) install(ctx context.Context, opts Options, args []string) error {
	...
	realitySNI := set.String("reality-server-name", "www.cloudflare.com", "домен Reality")
	realityTarget := set.String("reality-destination", "www.cloudflare.com:443", "назначение Reality")
